...
from .models import Cafe, Event, MenuItem, Rating, Club, CategoryFood, Picture, Theme
...
class CafeSerializer(ModelSerializer):
    ...
    class Meta: 
        model = Cafe
        fields = ['id', 'name', 'slug', 'theme', 'location', 'address', 'about', 'pictures', 'ratings', 'categories', 'club']
